...
const MODULES = {
  ...
  companySettings: {
    ...
    fields: {
      ...
      // Central administration expansion — see ARCHITECTURE.md §5.7.
      "Industry": "fldzcHzGg0PkySGKl",
      "Tax Number": "fldODFQovSuvy2pLh",
      "Description": "fldvKY9ua9URuTcgV",
      "Primary Colour": "fldkgEuDEEMDFdBl1",
      "Secondary Colour": "fldX7rChYiaQHF3cD",
      "Document Prefix": "fld9yRYty1lGmzBIr",
      "Default Version": "fldNwrNNmVYFlq4f6",
      "Document Footer": "fldO9wu0CdpFlKkiy",
      "Default Paper Size": "fldISfenI0SDPZ3SQ",
      "Default Orientation": "fldTbuYzyg3KkVcqR",
      "Default Language": "fldars8zKVaWnCBLP",
      "Company Confidential": "fldJLGAUAC1yNUm5Y",
      "Approved By": "fldQ6To11Ajd62gP6",
      "Approved By Position": "fld7L1D3r4blwQhHy",
      "Show Logo": "fldWLDEvSPBPVdHZA",
      "Show Company Stamp": "fldqwvnPZOEHATeKL",
      "Show Footer": "fld3AT5CidG9Spppb",
      "Show Page Numbers": "fldzen5h8VZLwKCMH",
      "Show Generated Date": "fldSGIlNmHduRqYvD",
      "Show Generated Time": "fld0m4Pp4YV0zdpmq",
      "Show Generated By": "fldkdt12EcvIRjPyP",
      "Repeat Table Headers": "fldH0pQZaxg90HSyx",
      "Show Document Version": "fldUwXMxGUwuIEtgM",
      "Show Document Number": "fldBRDSJ5mrXpBjmF",
    },
    dateKeys: [],
    ...
    attachments: [
      ...
      { key: "watermark", fieldId: "fldb6kpi7jiCpgnCl", label: "Watermark" },
      { key: "preparedBySignature", fieldId: "fldBSVvq20J31LIHk", label: "Prepared By Signature" },
      { key: "reviewedBySignature", fieldId: "fld9XC3IBy11zgxCA", label: "Reviewed By Signature" },
      { key: "approvedBySignature", fieldId: "fld3NpPIf6bJFBaVl", label: "Approved By Signature" },
    ],
  },
};
